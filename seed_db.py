...
def seed_db():
    ...
    try:
        ...
        # 3. Seed Users
        users_data = [
            {"id": "admin-1", "username": "admin", "full_name": "Admin User", "email": "admin@plaksha.edu", "role": "admin", "organisation": "Plaksha University", "department_team": "HR Tech", "total_points": 0, "skills": ["Management", "Logistics"]},
            ...
            {"id": "user-3", "username": "alex", "full_name": "Alex Rivera", "email": "alex@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Engineering", "total_points": 980, "skills": ["Python", "APIs", "Backend", "Data Analysis"]},
            {"id": "user-4", "username": "sarah", "full_name": "Sarah Chen", "email": "sarah@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Marketing", "total_points": 860, "skills": ["Marketing", "Content Creation", "Social Media", "Shorts"]},
            {"id": "user-5", "username": "mike", "full_name": "Mike Ross", "email": "mike@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Legal", "total_points": 620, "skills": ["Research", "Management"]},
            {"id": "user-6", "username": "hod-1", "full_name": "Director Jane", "email": "jane@plaksha.edu", "role": "head_of_department", "organisation": "Plaksha University", "department_team": "Leadership", "total_points": 320, "skills": ["Management", "Coordination", "Logistics"]},
            {"id": "user-7", "username": "priya", "full_name": "Priya Nair", "email": "priya@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Data Science", "total_points": 910, "skills": ["AI", "Machine Learning", "ML", "Data Science"]},
            {"id": "user-8", "username": "arjun", "full_name": "Arjun Mehta", "email": "arjun@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Automation Lab", "total_points": 840, "skills": ["Python", "Automation", "APIs"]},
            {"id": "user-9", "username": "nisha", "full_name": "Nisha Kapoor", "email": "nisha@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Community", "total_points": 760, "skills": ["Public Engagement", "Performance", "Marketing"]},
            {"id": "user-10", "username": "karan", "full_name": "Karan Sethi", "email": "karan@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Events", "total_points": 700, "skills": ["Logistics", "Coordination", "Event Coverage"]},
            ...
            {"id": "user-12", "username": "dev", "full_name": "Dev Malhotra", "email": "dev@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "AI Research", "total_points": 930, "skills": ["AI", "NLP", "Research", "Tech Trends"]},
            {"id": "user-13", "username": "meera", "full_name": "Meera Iyer", "email": "meera@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Media Lab", "total_points": 780, "skills": ["Video Editing", "Content Creation", "Premiere Pro", "Photography"]},
            {"id": "user-14", "username": "rohan", "full_name": "Rohan Bansal", "email": "rohan@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Product Innovation Lab", "total_points": 690, "skills": ["Entrepreneurship", "Pitching", "Management"]},
            {"id": "user-15", "username": "fatima", "full_name": "Fatima Khan", "email": "fatima@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Photography Studio", "total_points": 740, "skills": ["Photography", "Portraits", "Headshots", "Lighting"]},
            {"id": "user-16", "username": "vivek", "full_name": "Vivek Sharma", "email": "vivek@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Engineering", "total_points": 880, "skills": ["Backend", "Python", "Data Analysis"]},
            {"id": "user-17", "username": "sana", "full_name": "Sana Ali", "email": "sana@example.com", "role": "head_of_department", "organisation": "Plaksha University", "department_team": "Design Leadership", "total_points": 450, "skills": ["Design", "UI/UX", "Management"]},
            {"id": "user-18", "username": "rahul", "full_name": "Rahul Verma", "email": "rahul@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Workshops", "total_points": 590, "skills": ["Workshop", "Stance", "Public Engagement"]},
            {"id": "user-19", "username": "isha", "full_name": "Isha Dutta", "email": "isha@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Communications", "total_points": 670, "skills": ["Content", "Marketing", "Public Engagement"]},
            {"id": "user-20", "username": "neel", "full_name": "Neel Joshi", "email": "neel@example.com", "role": "contributors", "organisation": "Plaksha University", "department_team": "Operations", "total_points": 610, "skills": ["Logistics", "Management", "Coordination"]}
        ]
        ...
        opps_data = [
            ...
            },
            {
                ...
                "short_description": "Explore emerging AI trends and tools.",
                "full_description": "Present a brief findings assessment on new models and AI integration strategies.",
                "points_reward": 35,
                "schedule_time": "Sat, 1:00 PM",
                "location": "Innovation Lab",
                "time_required": "3 hours",
                "expectations": ["Research skills", "Presentation ability"],
                "skills": ["AI", "Research", "Tech Trends"],
                "tag_icon": '<circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline>',
                "bg_gradient": "linear-gradient(140deg, #eff6ff, #bfdbfe)",
                "icon_color": "#3b82f6",
                "main_icon": '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>'
            },
            {
                "id": "vid-clips",
                "type": "Initiative",
                "title": "Social Media Clips",
                "short_description": "Create short-form content for social platforms to drive engagement and clicks.",
                "full_description": "Work with the marketing team to brainstorm trends, align audio, and render final reels.",
                "points_reward": 40,
                "schedule_time": "Fri, 12:00 PM",
                "location": "Remote",
                "time_required": "4 hours/week",
                "expectations": ["Understanding of social media trends", "Basic editing skills"],
                "skills": ["Video Editing", "Social Media", "Shorts"],
                "tag_icon": '<circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline>',
                "bg_gradient": "linear-gradient(140deg, #f0fdf4, #bbf7d0)",
                "icon_color": "#22c55e",
                "main_icon": '<circle cx="12" cy="12" r="10"></circle><line x1="14.31" y1="8" x2="20.05" y2="17.94"></line>'
            },
            {
                "id": "vid-promo",
                "type": "Workshop",
                "title": "Promotional Video Editing",
                "short_description": "Assist in editing marketing videos adhering to brand guidelines efficiently.",
                "full_description": "Fast-paced workshop focusing on rapid assembly of promotional materials using provided assets.",
                "points_reward": 30,
                "schedule_time": "Mon, 4:00 PM",
                "location": "Studio",
                "time_required": "2 hours",
                "expectations": ["Familiarity with NLEs", "Attention to pacing"],
            ...
            },
            {
                ...
                "short_description": "Take professional headshots for contributors and leads.",
                "full_description": "Set up a pop-up headshot station, manage lighting properly, and deliver retouched photos.",
                "points_reward": 50,
                "schedule_time": "Tue, 4:00 PM",
                "location": "Lobby",
                "time_required": "3 hours",
                "expectations": ["Experience with portrait lighting", "Friendly disposition"],
            ...
            },
            {
                ...
                "short_description": "Assist in shooting product visuals and organizing accessory sets correctly.",
                "full_description": "Learn top-down photography styles and softbox lighting setups for e-commerce assets.",
                "points_reward": 40,
                "schedule_time": "Thu, 10:00 AM",
                "location": "Studio",
                "time_required": "2 hours",
                "expectations": ["Attention to detail", "Basic camera knowledge"],
            ...
            },
            {
                ...
                "short_description": "Engage in performance-based workshops improving speech and bodily stances.",
                "full_description": "Interactive sessions focusing on vocal projection, body language, and stage confidence.",
                "points_reward": 35,
                "schedule_time": "Mon, 5:30 PM",
                "location": "Drama Room",
                "time_required": "2 hours",
                "expectations": ["Willingness to participate", "Comfortable with group activities"],
            ...
            },
            {
                ...
                "short_description": "Assist in organizing performances managing backstages and queues reliably.",
                "full_description": "Ensure a smooth run-of-show, manage artists' entrances, and communicate with the A/V team.",
                "points_reward": 50,
                "schedule_time": "Sat, 6:00 PM",
                "location": "Auditorium Backstage",
                "time_required": "4 hours",
                "expectations": ["Excellent organizational skills", "Ability to handle pressure"],
